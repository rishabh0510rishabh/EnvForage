...
Located in `cli/tests/`. The `envforage-agent` must be tested across different operating systems. Since CI runners don't have multiple GPUs, we use **JSON Fixtures**.
