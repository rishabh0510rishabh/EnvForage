...
class Settings(BaseSettings):
    ...
    def validate_secret_key(self) -> "Settings":
        ...
        if self.environment != "development":
            ...
            # Rejecting only the committed default is not enough. A short,
            # low entropy key (for example "prod-key") is brute forceable and
            # lets an attacker recover the signing secret and forge JWTs.
            # Require at least 32 characters of key material outside development.
